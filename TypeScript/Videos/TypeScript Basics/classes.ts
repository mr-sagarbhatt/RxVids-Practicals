...
class ReferenceItem {
  ...
  // constructor
  constructor(numberOfPages: number, title: string, publisher?: string) {
  ...
  // method
  printChapterTitle(chapterTitle: string): void {
...
class Author1 {
  ...
  // Static Property
  static description: string = `A source of knowledge`; // Static Property
}
...
class Author2 {
  ...
  constructor(public name: string) {} // public is required, we can access using obj.name
}
